...
function Footer() {
  return (
    <div className="fixed bottom-0 w-full flex items-center justify-between bg-gray-800 px-4 py-2">
      ...
      <div className="flex items-center">
        <span className="flex justify-center mr-2 cursor-default select-none text-white font-normal text-xs">
          with
          <svg
